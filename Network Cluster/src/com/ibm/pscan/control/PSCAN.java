 ...
 * Input: inputFile name, outputFile name, threshold
 * When the threshold set to 0.0, it calculate the nearest structural similary
 * Otherwise, it cluster the networks into groups
 * 
 * @author Ningxin
 */
