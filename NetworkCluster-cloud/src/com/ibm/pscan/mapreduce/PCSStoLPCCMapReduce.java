...
public class PCSStoLPCCMapReduce {
	 ...
	 */
	public static class getAdListReducer extends Reducer<Text, Text, Text, ArrayListWritable<ArrayListWritable<Text>>> {
	...
	public static boolean getAdList(Configuration conf, String path) throws IOException, ClassNotFoundException, InterruptedException {
	    ...
	    FileInputFormat.addInputPath(getAdListJob, new Path(path+"/"+"pcss"));
	    FileOutputFormat.setOutputPath(getAdListJob, new Path(path+"/"+"lpccInput"));
